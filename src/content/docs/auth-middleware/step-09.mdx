...
Bayangkan bila ada banyak middleware yang ingin kita buat, tentu akan sangat `bloated` sekali file middleware ini nantinya kan?
...
Nah, pada saat menggunakan si `JSON Web Token`, yang menggunakan package `jsonwebtoken`, kita menggunakan fungsi verify di package tersebut,
