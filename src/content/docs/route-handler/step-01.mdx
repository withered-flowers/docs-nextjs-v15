...
### Seeding & Migration Drizzle

Setelah selesai membuat konfigurasi, selanjutnya kita akan melakukan seeding dan migration untuk membuat tabel yang kita buat sebelumnya.

1. Buka terminal
1. cd ke `sources/a-start/client-15`
1. Generate file migration dengan perintah `npx drizzle-kit migrate`
