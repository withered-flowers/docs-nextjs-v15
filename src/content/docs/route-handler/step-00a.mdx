...
export const GET = async (
    ...
    request: Request,
    // Parameter kedua adalah params (Optional, bila dibutuhkan)
...
Nah sampai di sini sudah mengerti yah kemampuan dari Route Handler ini, selanjutnya kita akan masuk ke demo yah untuk mencoba penggunaan Route Handler ini.